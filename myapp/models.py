...
class Bill(models.Model):
    ...
    credit_card = models.ForeignKey(CreditCard, on_delete=models.SET_NULL, null=True, blank=True)  # Add this line
...
class BillItem(models.Model):
    ...
    total_price = models.DecimalField(max_digits=10, decimal_places=2, default=Decimal('0.00'))  # Set default here
